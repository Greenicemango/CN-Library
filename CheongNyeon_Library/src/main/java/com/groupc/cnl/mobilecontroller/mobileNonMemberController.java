...
@Controller
public class mobileNonMemberController {
	...
	/* 비회원 구매 페이지 */
	@RequestMapping("/mobileNmemberBuyForm")
	public String nmemberBuyForm(HttpServletRequest request, Model model,
		...
		if(loginUser == null) {
			...
			url = "mobile/nonmember/mobile_nMemberBuyForm";
		}
		return url;
	}
	...
	/* 비회원 구매 */
	@RequestMapping(value="/mobileOrderninsert", method=RequestMethod.POST)
	public String orderninsert(HttpServletRequest request, Model model,
		...
		if(loginUser == null) {
			...
			url = "redirect:/mobileNOrderResult?od_pass=" + od_pass + "&bank=" + bank;
		}
		return url;
	}
	...
	/* 비회원 구매 결과 페이지 */
	@RequestMapping("/mobileNOrderResult")
	public String nOrderResult(HttpServletRequest request, Model model,
		...
		if(loginUser == null) {
			...
			url = "mobile/nonmember/mobile_nOrderResult";
		}
		return url;
	}
	...
	/* 비회원 주문 리스트 */
	@RequestMapping("/mobileNOrderList")
	public String nOrderList(HttpServletRequest request, Model model,
		...
		if(loginUser == null) {
			...
			url = "mobile/nonmember/mobile_nOrderList";
		}
		return url;
	}
	...
	/* 비회원 로그인 */
	@RequestMapping(value="/mobileNonmemberlogin", method=RequestMethod.POST)
	public String nonmemberlogin(HttpServletRequest request, Model model){
		String url = "mobile/member/mobilelogin";
		String msg = "";
		loginUser = (HashMap<String, Object>)request.getSession().getAttribute("loginUser");
		if(loginUser == null) {
	...
	/* 비회원 주문번호 찾기 */
	@RequestMapping(value="/mobileFindNMOd_passForm")
	public String findPwd() {
		return "mobile/nonmember/mobile_findNMOd_pass";
	}
	
	
	
	@RequestMapping(value = "/mobileFindNMOd_pass", method = RequestMethod.POST)
	public String pwdResult(HttpServletRequest request , Model model) {
		...
		if(nmName != null && nmPhone != null) {
			...
			model.addAttribute("message", "해당하는 주문번호가 없습니다!");
		}
		return "mobile/nonmember/mobile_findNMOd_pass";
	}
}
