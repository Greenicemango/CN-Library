...
<form method="post" name="joinForm" action="mobileMemberUpdate" style="text-align:center;">
<div id="mobile_main_Frame" style="text-align:center;">
	<div id="join">
		<div class="mobile_title">회원정보수정</div>
		<div id="blueLabel"></div>
		<span style="font-size:30px;">${message }</span>
		
		<div class="joincategory">이름 *</div>
		<input type="text" name="name" class="joininput" value="${dto.name}">
		
		<div class="joincategory">아이디 *</div>
		<input type="text" name="id" class="joininput" value="${dto.id}" readonly>
		
		<div class="joincategory" s>비밀번호 *</div>
		<input type="password" name="pwd" class="joininput">
		
		<div class="joincategory">비밀번호 확인 *</div>
		<input type="password" name="pwdCheck" class="joininput">
	
		<div class="joincategory">이메일 *</div>
		<input type="text" name="email" class="joininput" value="${dto.email}">
		...
		<input type="text" name="zip_num" size="10" class="joininput" value="${dto.zip_num}" style="width:60%; float:left; margin-left:2.5%;">&nbsp;&nbsp;
		...
		<input type="text" name="phone" class="joininput" value="${dto.phone}">
		...
		<div id="buttons">
			<input type="submit" value="정보수정" class="joinbutton" style="margin: 20px 20px 20px 0;">
			<input type="button" value="취소" class="joinbutton" onClick="location.href='/'">
		</div>
	</div>
</div>
</form>
