...
<div id="mobile_main_Frame" style="text-align:center;">
	<div id="findResult">
		회원님의 청년문고 아이디는<br>
		<span class="resultText">${memberList.ID}</span> 입니다.
	</div>
	<div>
		<input type="button" class="joinbutton" value="비밀번호 찾기" onClick="location.href='mobileFindPwd'" style="width: 250px; font-size:40px; line-height:40px; margin-bottom:40px;">
