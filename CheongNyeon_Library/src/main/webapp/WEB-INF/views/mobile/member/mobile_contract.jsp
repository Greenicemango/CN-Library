...
<div id="mobile_main_Frame" style="text-align:center;">
	<div id="login">
		<div class="mobile_title">회원 가입</div>
		<form id="join" method="post" name="contractFrm" action="mobileJoinForm" style="width:100%;">
			<strong id="agree">약관동의</strong>
			<div id="blueLabel"></div>
			<textarea class="con_text" rows="13" cols="75" style="width: 100%;height: 100%;font-size: 20px;">
제 1 장 총 칙
...
(3) 서비스 이용으로 발생한 분쟁에 대해 소송이 제기되는 경우 회사의 본사 소재지를 관할하는 법원을 관할 법원으로 합니다.
			...
			<input type="submit" value="동의 및 회원가입 진행" class="agreebtn">	
		</form>
	</div>
</div>
</body>
